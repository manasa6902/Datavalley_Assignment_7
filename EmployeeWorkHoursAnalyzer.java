...
public class EmployeeWorkHoursAnalyzer {
    public static void main(String[] args) {
        ...
        workHoursList.add(new EmployeeWorkHours("Hani", new int[]{8, 8, 8, 8, 8}));
        workHoursList.add(new EmployeeWorkHours("Chandu", new int[]{9, 9, 8, 8, 7}));
        workHoursList.add(new EmployeeWorkHours("Pavan", new int[]{8, 8, 7, 7, 5}));
        workHoursList.add(new EmployeeWorkHours("Shannu", new int[]{8, 8, 8, 8, 4}));
        workHoursList.add(new EmployeeWorkHours("Priya", new int[]{10, 10, 10, 10, 10}));
